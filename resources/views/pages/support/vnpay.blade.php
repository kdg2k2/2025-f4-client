            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="">
                            <p class="mb-3 content-1 h5 text-white text-center">HƯỚNG DẪN THANH TOÁN VNPAY TRÊN
                                WEBSITE</p>
                            <p class="mb-0 tx-26 text-center">Mọi điều bạn cần biết về thanh toán VNPAY.</p>
                        </div>
                    </div>
                </div>
            </div>
