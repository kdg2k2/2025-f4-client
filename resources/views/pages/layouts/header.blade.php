                                        ...
                                        <ul>
                                            <li class="slide">
                                                <a href="satellite-imagery/index" class="side-menu__item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3"><span
                                                                class="avatar header__dropavatar bg-success-transparent rounded-circle">
                                                                <i class="bi bi-image me-0 tx-success"></i> </span>
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="slide">
                                                <a href="satellite-imagery/index" class="side-menu__item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3"><span
                                                                class="avatar header__dropavatar rounded-circle bg-purple-transparent">
                                                                <i class="bi bi-file-image me-0 tx-purple"></i> </span>
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="slide">
                                                <a href="satellite-imagery/index" class="side-menu__item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3"><span
                                                                class="avatar header__dropavatar bg-warning-transparent rounded-circle">
                                                                <i class="bi bi-cloud me-0 tx-warning"></i> </span>
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="slide">
                                                <a href="satellite-imagery/index" class="side-menu__item">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3"><span
                                                                class="avatar header__dropavatar rounded-circle bg-danger-transparent">
                                                                <i class="bi bi-images me-0 tx-danger"></i> </span>
                                                        </div>
                                                        <div class="flex-grow-1">
