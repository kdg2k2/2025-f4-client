<div class="offcanvas offcanvas-end" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center gap-2 px-3 py-3 offcanvas-header border-bottom border-dashed">
        <h5 class="flex-grow-1 mb-0">Cài đặt giao diện</h5>
    ...
    <div class="offcanvas-body p-0 h-100" data-simplebar>
        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Chủ đề</h5>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Sáng</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Tối</h5>
                </div>
            </div>
        </div>

        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Nền menu ngang</h5>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Mặc định</h5>
                </div>
        ...
        <div class="p-3 border-bottom border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Nền menu chức năng</h5>
        ...
        <div class="p-3 .border-bottom .border-dashed">
            <h5 class="mb-3 fs-16 fw-bold">Kiểu menu</h5>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Nhỏ gọn</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Ngưng tụ</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Trỏ chuột</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Đầy đủ kích thước</h5>
                </div>
                ...
                <div class="col-4">
                    ...
                    <h5 class="fs-14 text-center text-muted mt-2">Ẩn giấu</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center gap-2 px-3 py-2 offcanvas-header border-top border-dashed">
        <button type="button" class="btn w-100 btn-soft-danger" id="reset-layout">Khôi phục mặc định</button>
    </div>
