                                                ...
                                                <thead>
                                                    <tr style="background: #308e87;">
                                                        <th style="padding: 18px 15px; text-align: left"><span
                                                                style="color: #fff; font-size: 16px; font-weight: 600;">Mô tả</span>
                                                        </th>
                                                        <th
                                                            style="padding: 18px 15px; text-align: center;border-right: 3px solid #fff;">
                                                            <span
                                                                style="color: #fff; font-size: 16px; font-weight: 600;">Giá tiền</span>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                    ...
                                                    <tr
                                                        ...
                                                        <td>
                                                            <span
                                                                ...
                                                                tiền</span>
                                                            <h4 style="font-weight:600; margin: 12px 0 5px 0; font-size: 26px; color:#308e87;">
