...
const getDocuments = (param) => {
    ...
    const dataTable = createDataTableServerSide(
        ...
        (item) => {
            const btnView = `<a href="/admin/documents/${item.id}/view" title="Xem" class="btn btn-sm btn-outline-info rounded-pill" data-bs-toggle="tooltip" data-placement="top"><i class="fa-solid fa-eye"></i></a>`;
            ...
            return {
                ...
                actions: `<div class="text-center">${btnBuy} ${btnAddCart} ${btnView}</div>`,
            };
        },
        param
    );
